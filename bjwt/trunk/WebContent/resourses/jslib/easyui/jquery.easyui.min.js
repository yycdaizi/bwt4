...
tip.find(".validatebox-tip-content").html(msg);
tip.css({display:"block",left:box.position().left+box.outerWidth(),top:box.position().top});
//--------
*/
};
function _2ea(_2ed){
...
//---------
_5d1.bind('focus.combo', function(){
	opts.box.onfocus.call(_5ce);
}).bind('blur.combo', function(){
	opts.box.onblur.call(_5ce);
}).bind('click.combo', function(){
	opts.box.onclick.call(_5ce);
});
//---
...
box:{onfocus:function(){},onclick:function(){},onblur:function(){}}
//-------------
});
})(jQuery);
(function($){
...
//---------------
if($(this).combo('panel').panel('options').closed){

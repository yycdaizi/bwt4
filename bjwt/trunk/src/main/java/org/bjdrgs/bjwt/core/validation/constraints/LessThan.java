...
import org.bjdrgs.bjwt.core.validation.validators.LessThanForNumber;
...
@Retention(RUNTIME)
@Documented
@Constraint(validatedBy = LessThanForNumber.class)
public @interface LessThan {
	String message() default "{javax.validation.constraints.LessThan.message}";
